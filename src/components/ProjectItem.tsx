  ...
  return (
    <div className="p-5 bg-second rounded-lg group">
      <div className="flex gap-5 flex-col justify-center items-center lg:flex-row">
        <div className={id % 2 === 0 ? 'order-1' : 'order-0'}>
        ...
        <div className="hidden lg:p-0 lg:block flex-1/2 min-h-[300px] overflow-hidden relative group-hover:bg-white">
          <div className="absolute w-full h-full top-0 left-0 transition-all z-10 opacity-20 group-hover:bg-orange"></div>
          <img
            className="max-w-full rounded-lg w-full h-full object-cover absolute top-0 left-0 transition-all group-hover:scale-125"
            src={img}
            alt="Project"
          />
        </div>
