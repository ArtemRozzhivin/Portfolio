  ...
  return (
    <div className="flex">
      <div>
        ...
        <h1 className="text-7xl text-orange">Rozzhyvin Artem</h1>
        <p>
          A self-taught front-end developer with a passion for exploration and continual learning. I
          am a highly motivated person, willing to work in a team or as an individual worker as
          well. I strive to apply my experience and skills to help businesses and companies achieve
          its goals, creating a user-oriented digital products.
        </p>
        <p>I'm currently open to new opportunities, so feel free to contact me.</p>
