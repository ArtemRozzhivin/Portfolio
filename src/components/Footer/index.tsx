...
const Footer: React.FC = () => {
  return (
    <footer className='py-4 bg-[#020917] xs:px-4'>
      <div className='max-w-container mx-auto flex flex-col gap-3 md:flex-row justify-between items-center'>
        <p className='text-center'>
          Made by <span className='text-orange'>Artem Rozzhyvin</span> — Copyright 2024
        </p>
